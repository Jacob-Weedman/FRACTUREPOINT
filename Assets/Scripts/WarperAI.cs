...
//MISC METHODS
    ...
    async Task UseWeapon()
    {
        ...
        //Set Variables
        EvilAura.GetComponent<ParticleWeapon>().destroy = true;
        EvilAura.GetComponent<ParticleWeapon>().opacity = true;
        EvilAura.GetComponent<ParticleWeapon>().rotate = true;
        EvilAura.GetComponent<ParticleWeapon>().damageAmmount = WeaponDamage;
